...
One means that the candy does have chocolate, while zero means that it does not have chocolate.
...
```
I would say it is slightly above 50%
...
On average, chocolate candy is ranked higher than fruit candy by almost 20%!
...
The above barplot shows me visually, the correlation in two different ways: horizontal and vertical.
This is another way to view the correlation plot.
